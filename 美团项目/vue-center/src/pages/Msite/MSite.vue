  ...
  <div class="msite">
    ...
    <!-- <header class="header">
      ...
      <a class="header_title">
        <span class="header_title_text ellipsis">河南省项城市</span>
      </a>
        ...
        <ul class="shop_list">
            ...
            <a>
              ...
              <div class="shop_right">
                ...
                <section class="shop_raring_order">
                  ...
                  <section class="shop_rating_order_right">
                    <span class="delivery_style delivery_left">美团专送</span>
